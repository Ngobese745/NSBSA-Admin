          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 4),
                _detailRow('Initiation Fee', 'R ${(loan.initiationFee ?? 0).toStringAsFixed(0)}'),
                _detailRow('Monthly Admin Fee', 'R ${(loan.monthlyAdminFee ?? 0).toStringAsFixed(0)} / mo'),
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              _pdfRow('Initiation Fee:', 'R ${(loan.initiationFee ?? 0).toStringAsFixed(2)}'),
              _pdfRow('Admin Fees:', 'R ${((loan.monthlyAdminFee ?? 0) * loan.durationMonths).toStringAsFixed(2)} (Total)'),
              pw.SizedBox(height: 24),
